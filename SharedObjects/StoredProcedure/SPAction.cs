...
namespace SharedObjects.StoredProcedure
{
    ...
    {
        public static string Action_get = "usp_Action_get_new @p0,@p1,@p2,@p3,@p4";
        ...
        public static string Action_acknowledge = "usp_Action_acknowledge @p0,@p1,@p2,@p3";// need to add display name
